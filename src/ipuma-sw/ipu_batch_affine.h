...
class SWAlgorithm : public IPUAlgorithm {
 ...
 public:
  ...
  static void prepare_remote(IPUAlgoConfig& algoconfig, SWConfig& config, const std::vector<std::string>& A, const std::vector<std::string>& B,  int32_t* inputs_begin,  int32_t* inputs_end, std::vector<int>& deviceMapping);
};
}  // namespace batchaffine
}  // namespace ipu
