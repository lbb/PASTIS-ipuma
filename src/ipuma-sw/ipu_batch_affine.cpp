...
void SWAlgorithm::compare_local(const std::vector<std::string>& A, const std::vector<std::string>& B) {
  ...
  prepare_remote(algoconfig, config, A, B, &*inputs.begin() + 2, &*inputs.end() - 2, mapping);
...
void SWAlgorithm::prepare_remote(IPUAlgoConfig& algoconfig, SWConfig& config, const std::vector<std::string>& A, const std::vector<std::string>& B, int32_t* inputs_begin, int32_t* inputs_end, std::vector<int>& seqMapping) {
