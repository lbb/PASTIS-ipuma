...
void SeqanFullAligner::construct_seqs(std::shared_ptr<DistFastaData> dfd) {
...
void SeqanFullAligner::construct_seqs_bl(std::shared_ptr<DistFastaData> dfd) {
  string s_tmp;
...
void SeqanFullAligner::aln_batch(
